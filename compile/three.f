...
!!     Debugging
!!------------------------------       
!      write(6,12) 'zgm1', (zgm1(i,1),i=1,lx1)
!      write(6,*) 'Right Ext.'
!      call copy(tmpx(2,1),zgm2(1,1),lx2)
!      tmpx(1,1)    = zgm1(1,1) + 0.0*(zgm2(lx2,1)-zgm1(lx1,1))
!      tmpx(lx1,1)  = zgm1(lx1,1) + (zgm2(1,1)-zgm1(1,1))
!
!      call mxm(dph,lx1,tmpx(1,1),lx1,tmpx(1,2),1)
!      write(6,12) 'lr21', (tmpx(i,1),i=1,lx1)
!      write(6,12) 'dph2', (1.0/tmpx(i,2),i=1,lx1)
!
!      write(6,*) 'No Ext.'
!      call copy(tmpx(2,1),zgm2(1,1),lx2)
!      tmpx(1,1)    = zgm1(1,1) + 0.0*(zgm2(lx2,1)-zgm1(lx1,1))
!      tmpx(lx1,1)  = zgm1(lx1,1) + 0.0*(zgm2(1,1)-zgm1(1,1))
!
!      call mxm(dph,lx1,tmpx(1,1),lx1,tmpx(1,2),1)
!      write(6,12) 'lr21', (tmpx(i,1),i=1,lx1)
!      write(6,12) 'dph2', (1.0/tmpx(i,2),i=1,lx1)
!
!
!      call copy(tmpx(1,1),lr1(1,1),lx1)
!      call mxm(dph,lx1,tmpx(1,1),lx1,tmpx(1,2),1)
!      write(6,*) 'Actual'
!      write(6,12) 'lr21', (tmpx(i,1),i=1,lx1)
!      write(6,12) 'lr21', (tmpx(i,1)*2,i=1,lx1)
!      write(6,12) 'dph2', (1.0/tmpx(i,2),i=1,lx1)
!!------------------------------ 
...
!      call exchange_m2(tmp2,tmp8,tmp5,tmp6,tmp7)
!
!      call copy(tmp3,tmp1,n)
!      call copy(tmp5,tmp2,n)
!
!      do e=1,nelv
!        call mxm(dph,lx1,tmp3(1,1,1,e),lx1,tmp1(1,1,1,e),lx1)
!        call mxm(tmp5(1,1,1,e),lx1,dpht,lx1,tmp2(1,1,1,e),lx1)
!      enddo  
!
!      call outpost(tmp1,tmp2,tmp3,tmp4,tmp5,'tmp')    ! No Geom Fac.
